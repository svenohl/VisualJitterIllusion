  ...
  if (i <= 5*lastimage/6){
    ...
    #image(display,col=color.gradient(display))
  ...
  if (i > 5*lastimage/6){
    inc <- inc+1
      ...
      #image(display,col=color.gradient(display))
      points((screen.x/2+shiftmat[1,1])/screen.x,(screen.y/2+shiftmat[1,2])/screen.y,col=hcl(0+inc*25,100,100),pch=16,cex=2)
      points((screen.x/2+shiftmat[2,1])/screen.x,(screen.y/2+shiftmat[2,2])/screen.y,col=hcl(0+inc*25,100,100),pch=16,cex=2)
      points((screen.x/2+shiftmat[3,1])/screen.x,(screen.y/2+shiftmat[3,2])/screen.y,col=hcl(0+inc*25,100,100),pch=16,cex=2)
      points((screen.x/2+shiftmat[4,1])/screen.x,(screen.y/2+shiftmat[4,2])/screen.y,col=hcl(0+inc*25,100,100),pch=16,cex=2)
      points(0.5,0.5,col="blue",cex=3,pch=16)    
      dev.off()
  }
  }
